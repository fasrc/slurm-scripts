...
# Kempner PI Labs
kempner_pi_labs=$(echo alvarez_lab ba_lab barak_lab bsabatini_lab gershman_lab jfrankle_lab konkle_lab krajan_lab murphy_lab mzitnik_lab pehlevan_lab sham_lab sompolinsky_lab)
