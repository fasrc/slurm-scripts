...
sacctmgr -i modify account name=arguelles_delgado_lab set fairshare=1418
...
sacctmgr -i modify account name=koumoutsakos_lab set fairshare=7175
...
sacctmgr -i modify account name=viegas_lab set fairshare=8724
sacctmgr -i modify account name=vishwanath_lab set fairshare=216
sacctmgr -i modify account name=wattenberg_lab set fairshare=3706
sacctmgr -i modify account name=whipple_lab set fairshare=408
sacctmgr -i modify account name=wofsy_lab set fairshare=729
